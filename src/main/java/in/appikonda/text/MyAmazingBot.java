	    ...
	    public void onUpdateReceived(Update update) {
	        ...
	        if (update.hasMessage() && update.getMessage().hasText()) {
	            ...
	            if (message_text.equals("/start")) {
	            	...
	            	GetChat chat = new GetChat().setChatId(chat_id);
	            	GetChatAdministrators cha = new GetChatAdministrators().setChatId(chat_id);
	            	GetChatMember cm = new GetChatMember().setChatId(chat_id);
	            	GetUserProfilePhotos gup= new GetUserProfilePhotos().setUserId(update.getMessage().getFrom().getId());
	            	
	            	SendMessage msg = new SendMessage()
	                        .setChatId(chat_id)
	                        .setText(update.getMessage().getFrom().getFirstName() +" "+update.getMessage().getFrom().getLastName()  );
            	 try {
